...
public class ItemBasicusSword extends ElementsBolariansIncredibleMod.ModElement {
	@GameRegistry.ObjectHolder("bolarianincrediblemod:basicussword")
	public static final Item block = null;
	public ItemBasicusSword(ElementsBolariansIncredibleMod instance) {
		super(instance, 10);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("bolarianincrediblemod:basicussword", "inventory"));
	}
}
